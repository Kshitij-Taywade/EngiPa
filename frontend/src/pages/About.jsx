...
const About = () => {
  ...
  <section  className="about-section1">
      <h3>About EngiPa</h3>
      <p>" EngiPa is a platform built for engineering students to access and succeed with academic resources — faster and smarter. "</p>
</section>
...
<section  className="about-section1">
      <h3>Join Us</h3>
      <p>" Be a part of EngiPa and make your academic journey smarter, faster, and more efficient."</p>
</section>
